...
class GameActivity: AppCompatActivity(){
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tHighScore = findViewById(R.id.tv_high_score)
        tCurrentScore = findViewById(R.id.tv_current_score)
    ...
    private fun updateHighScore(){
        tHighScore?.text = "${appPreferences?.getHighScore()}"
    }
    private fun updateCurrentScore(){
        tCurrentScore?.text = "0"
    }
}